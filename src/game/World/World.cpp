...
void World::LoadConfigSettings(bool reload)
{
	...
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_BRD, "Rate.Creature.Dungeon.Scale.Blackrock.Depths", 1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_STRAT, "Rate.Creature.Dungeon.Scale.Stratholme", 1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_DIREMAUL, "Rate.Creature.Dungeon.Scale.Dire.Maul", 1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_SCHOLO, "Rate.Creature.Dungeon.Scale.Scholomance ", 1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_1, "Rate.Creature.Dungeon.Scale.Party.Size.1", 0.2f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_2, "Rate.Creature.Dungeon.Scale.Party.Size.2", 0.4f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_3, "Rate.Creature.Dungeon.Scale.Party.Size.3", 0.6f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_4, "Rate.Creature.Dungeon.Scale.Party.Size.4", 0.8f);
	setConfigPos(CONFIG_FLOAT_RATE_CREATURE_DUNGEON_SCALE_5, "Rate.Creature.Dungeon.Scale.Party.Size.5", 1.0f);
